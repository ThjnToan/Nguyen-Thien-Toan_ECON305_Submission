...
def grow_economy(myClass):
    ...
    g = par.g  # Adjusted growth rate of technology
    T0 = par.T0  # Initial technology level
    ...
    Tsim = zeros(par.T*2) # Container for simulated technology level
    ...
    Tsim[0] = T0  # Initial technology level
    ...
    for j in range(1,T*2): # Time loop.
        ...
        Tsim[j] = Tsim[j-1] * (1 + g)  # Update technology level with adjusted growth rate
    ...
    sim.Tsim = Tsim[T:2*T+1] # Simulated technology level