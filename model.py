...
class planner():
    ...
    def setup(self,**kwargs):
        ...
        par.T0 = 1.0  # Initial level of technology

        par.policy_g = 0.0  # Default policy parameter for technology growth rate increase
        ...
        # Adjust the growth rate of technology based on policy
        par.g += par.policy_g
        ...
        print('g: ',par.g)
        print('T0: ',par.T0)
        print('policy_g: ',par.policy_g)
        print('g (adjusted): ',par.g)
